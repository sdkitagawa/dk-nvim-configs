...
-- C:/Users/<user>/AppData/Local/nvim/after/plugin/c_env.lua

local env_path = vim.fn.stdpath("config") .. "/.env"
local env = require("env").load_env(env_path)

local workspace_dir = env.C_WINDOWS_WORKSPACE or vim.fn.expand(".")
...
vim.api.nvim_create_user_command("CEnv", cd_to_workspace, {})
