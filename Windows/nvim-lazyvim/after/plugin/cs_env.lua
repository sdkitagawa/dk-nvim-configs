-- ~/.config/nvim/after/plugin/cs_env.lua
-- C:/Users/user_name/AppData/Local/nvim/after/plugin/cs_env.lua

local env_path = vim.fn.stdpath("config") .. "/.env"
local env = require("env").load_env(env_path)

local workspace_dir = env.CS_WINDOWS_WORKSPACE or vim.fn.expand(".")
...
vim.api.nvim_create_user_command("CsEnv", cd_to_workspace, {})
