...
local workspace_dir = vim.fn.expand("/Users/dkitagawa/Documents/DK's Coding Workspace/javascript")
...
vim.keymap.set(
  ...
  "<leader>dw",
  cd_to_workspace,
  { desc = "cd to /Users/dkitagawa/Documents/DK's Coding Workspace/javascript" }
)
