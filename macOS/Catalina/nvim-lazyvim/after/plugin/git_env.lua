...
local workspace_dir = vim.fn.expand("/Users/dkitagawa/Documents/GitHub")
...
vim.keymap.set("n", "<leader>dw", cd_to_workspace, { desc = "cd to /Users/dkitagawa/Documents/GitHub" })
